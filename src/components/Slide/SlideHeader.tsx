...
export function SlideHeader({
  ...
  return (
    <div className="flex items-center justify-end px-6 py-4 border-b border-gray-200 flex-shrink-0">
      <div className="flex items-center gap-3">
        ...
        {/* View Mode Toggle */}
        <div className="flex items-center bg-gray-200 rounded-lg p-1 shadow-sm">
          <button
