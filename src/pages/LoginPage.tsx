    ...
    try {
      ...
      if (!hasEmail && hasGoogle) {
        ...
        setTimeout(async () => {
          ...
          if (error) {
            setGoogleRedirectMessage(false)
            setError(error)
          }
        }, 1500)
        setIsCheckingProviders(false)
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent text-gray-900 placeholder-gray-500 disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  value={email}
                  readOnly
                  className="w-full px-4 py-3 border border-gray-300 rounded-2xl bg-gray-50 text-gray-600 cursor-not-allowed"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent text-gray-900 placeholder-gray-500 disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                  <button
                    type="button"
      ...
      {googleRedirectMessage && (
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50">
          <div className="px-6 py-4 bg-blue-50 border border-blue-200 rounded-2xl shadow-lg">
            <p className="text-sm text-blue-600 font-medium">This account uses Google. Redirecting...</p>
          </div>
        </div>
      )}
    </div>
